...
/**
 * the platform provider slug -> models.dev provider id.
...
class ModelPricing {
  ...
  /**
   * @param {string|null} providerSlug - the platform provider slug
 ...
 * @param {Object} opts
 * @param {string|null} opts.provider - the platform provider slug
