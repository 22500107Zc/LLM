...
/**
 * An interface to the Community Hub external API.
 */
const CommunityHub = {
   ...
   * so we can unzip and import them to the deployment.
  ...
  /**
   * Apply an item to the deployment. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the deployment by downloading the zip file and importing it.
