...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "{{appName}} fungerar med många LLM-leverantörer. Den här tjänsten hanterar chattningen.",
    },
    userSetup: {
    ...
    survey: {
      title: "Välkommen till {{appName}}",
      description:
        "Hjälp oss att utveckla {{appName}} för dina behov. Valfritt.",
      email: "Vad är din e-postadress?",
      useCase: "Vad ska du använda {{appName}} till?",
      useCaseWork: "Arbete",
      useCasePersonal: "Personligt bruk",
      useCaseOther: "Annat",
      comment: "Hur fick du höra talas om {{appName}}?",
      commentPlaceholder:
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Aktivera obegränsat antal verktyg och minska tokenanvändningen med upp till 80 % per fråga – {{appName}} väljer automatiskt rätt färdigheter för varje prompt.",
        "max-tools": {
  ...
  customization: {
    interface: {
      ...
      description: "Ange dina gränssnittsinställningar för {{appName}}.",
    },
    branding: {
      title: "Varumärke och vitmärkning",
      description: "Vitmärka din {{appName}}-instans med anpassad profilering.",
    },
    chat: {
      title: "Chatt",
      description: "Ange dina chattinställningar för {{appName}}.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Visningsspråk",
        description:
          "Välj det språk som {{appName}}:s gränssnitt ska visas på när översättningar finns tillgängliga.",
      },
      logo: {
  ...
  api: {
    title: "API-nycklar",
    description:
      "API-nycklar ger innehavaren programmatisk åtkomst till och möjlighet att hantera denna {{appName}}-instans.",
    ...
    modal: {
      ...
      helper:
        "När API-nyckeln har skapats kan den användas för att programmässigt komma åt och konfigurera denna {{appName}}-instans.",
      name: {
        label: "Namn",
  ...
  llm: {
    title: "LLM-inställning",
    description:
      "Här finns autentiseringsuppgifter och inställningar för din valda LLM-leverantör för chatt och inbäddning. Det är viktigt att nycklarna är aktuella och korrekta, annars fungerar inte {{appName}} som det ska.",
  ...
  transcription: {
    ...
    "warn-start":
      "Att använda den lokala Whisper-modellen på datorer med begränsat RAM eller CPU kan göra att {{appName}} hänger sig när mediefiler behandlas.",
  ...
  embedding: {
    ...
    "desc-end":
      "Inbäddning är processen att omvandla text till vektorer. Dessa autentiseringsuppgifter behövs för att omvandla dina filer och promptar till ett format som {{appName}} kan behandla.",
    provider: {
  ...
  vector: {
    title: "Vektordatabas",
    description:
      "Här finns autentiseringsuppgifter och inställningar för hur {{appName}}-instansen fungerar. Det är viktigt att nycklarna är aktuella och korrekta.",
    provider: {
  ...
  telegram: {
    title: "Telegram-bot",
    description:
      "Anslut din {{appName}}-instans till Telegram så att du kan chatta med arbetsytorna från vilken enhet som helst.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Skydda {{appName}}-instansen med ett lösenord. Om du glömmer det går det inte att återställa, så se till att spara lösenordet.",
  ...
  privacy: {
    ...
    description:
      "Här konfigurerar du hur anslutna tredjepartsleverantörer och {{appName}} hanterar dina data.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Dessa filer laddas upp till dokumentprocessorn som körs på denna {{appName}}-instans. Filerna skickas inte till eller delas med tredje part.",
    },
    pinning: {
      what_pinning: "Vad är fästning av dokument?",
      pin_explained_block1:
        "När du <b>fäster</b> ett dokument i {{appName}} infogas hela dokumentinnehållet i promptfönstret så att LLM:en kan förstå det fullt ut.",
      pin_explained_block2:
        "Detta fungerar bäst med <b>modeller med stor kontext</b> eller små filer som är viktiga för kunskapsbasen.",
      pin_explained_block3:
        "Om du inte får önskade svar från {{appName}} som standard är fästning ett enkelt sätt att få svar av högre kvalitet.",
      accept: "Okej, jag förstår",
    },
    watching: {
      what_watching: "Vad innebär det att bevaka ett dokument?",
      watch_explained_block1:
        "När du <b>bevakar</b> ett dokument i {{appName}} synkroniseras dokumentinnehållet <i>automatiskt</i> från ursprungskällan med jämna mellanrum. Detta uppdaterar automatiskt innehållet i varje arbetsyta där filen hanteras.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Minne",
        placeholder:
          "t.ex. Användaren heter Kim, användaren arbetar med {{appName}} osv.",
        create: "Skapa",
        save: "Spara",
        cancel: "Avbryt",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Du måste autentisera med {{appName}} Community Hub innan du publicerar objekt.",
