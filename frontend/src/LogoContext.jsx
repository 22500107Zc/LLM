...
import PlatformWordmark from "./media/logo/platform-wordmark.png";
import PlatformWordmarkDark from "./media/logo/platform-wordmark-dark.png";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode()
          ? setLogo(PlatformWordmarkDark)
          : setLogo(PlatformWordmark);
        setLoginLogo(DefaultLoginLogo);
        setIsCustomLogo(false);
      }
    } catch (err) {
      isLightMode() ? setLogo(PlatformWordmarkDark) : setLogo(PlatformWordmark);
      setLoginLogo(DefaultLoginLogo);
      setIsCustomLogo(false);
