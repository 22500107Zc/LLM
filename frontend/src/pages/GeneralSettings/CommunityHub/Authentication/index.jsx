            ...
            <div className="border border-theme-border my-2 flex flex-col md:flex-row md:items-center gap-x-2 text-theme-text-primary mb-4 bg-theme-settings-input-bg w-1/2 rounded-lg px-4 py-2">
              <div className="flex flex-col gap-y-2">
                ...
                <p className="text-sm text-theme-text-secondary">
                  ...
                  your <b>private</b> items from the the platform Community Hub
                  as well as upload your own items to the Community Hub.
                  <br />
                  <br />
                  <i>
                    You do not need to connect your Community Hub account to
                    pull in public items from the the platform Community Hub.
                  </i>
                </p>
              </div>
            </div>
          ...
          <div className="mt-6 mb-12">
            <div className="flex flex-col w-full max-w-[400px]">
              ...
              <input
                ...
                placeholder="Enter your the platform Hub API key"
              />
