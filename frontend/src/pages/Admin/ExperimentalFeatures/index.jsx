          ...
          <form onSubmit={acceptTos} className="flex flex-col gap-y-5">
            ...
            <ModalBody>
              <div className="w-full text-zinc-300 light:text-slate-700 text-md flex flex-col gap-y-4">
                <p>
                  Experimental features of the platform are features that we are
                ...
                <div>
                  ...
                  <ul className="list-disc ml-6 text-sm font-mono mt-2">
                    ...
                    <li>Potential bugs or issues using the platform.</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc ml-6 text-sm font-mono mt-2">
                    ...
                    <li>
                      ...
                      configurations, or subscriptions of the platform.
                    </li>
                    <li>
                ...
                <p>
                  ...
                  <a
                    href={paths.docs("/beta-preview/overview")}
